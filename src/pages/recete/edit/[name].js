...
const EditRecipe = ({ recipe }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    setLoading(true)
    const response = await fetch('/api/updaterecete', {
      method: 'PUT',
      headers: {
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-neutral-50 py-12 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900">Tarifi Düzenle</h1>
          <p className="mt-3 text-lg text-gray-600">Tarifinizi güncelleyin ve paylaşın</p>
        </div>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center p-12 bg-white rounded-2xl shadow-xl">
            ...
            <p className="text-lg text-gray-600">Tarif güncelleniyor...</p>
          </div>
        ) : (
